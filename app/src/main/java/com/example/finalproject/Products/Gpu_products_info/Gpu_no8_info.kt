...
class Gpu_no8_info : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.gpu_no8_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.gpu_img8,
            R.drawable.gpu_info8_img1,
            R.drawable.gpu_info8_img2,
            R.drawable.gpu_info8_img3)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(38, "MSI RX 580 GAMING X 8 GB", 12130.00, "GPU", R.drawable.gpu_img8, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)


            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Gpu8")
            startActivity(int)
        }
