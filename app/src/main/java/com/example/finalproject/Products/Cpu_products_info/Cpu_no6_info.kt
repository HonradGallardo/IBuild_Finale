...
class Cpu_no6_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var cpuCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.cpu_no6_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.cpu_img6,
            R.drawable.cpu_info6_img1,
            R.drawable.cpu_info6_img2,
            )
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(16, "Intel Pentium Gold G6400", 4199.00, "CPU", R.drawable.cpu_img6, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)


            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Cpu6")
            startActivity(int)
        }
