...
class Monitor_no2_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var MonitorCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.monitor_no2_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.monitor_img2,
            R.drawable.monitor_info2_img1,
            R.drawable.monitor_info2_img4,
            R.drawable.monitor_info2_img2,
            R.drawable.monitor_info2_img3,)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(80, "ViewSonic VX3276-MHD 32 inch 6oHz", 11969.46, "Monitor", R.drawable.monitor_img2, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Monitor2")
            startActivity(int)
        }
