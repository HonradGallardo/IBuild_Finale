...
class Monitor_no1_info : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val images = listOf(
            R.drawable.monitor_info1_img1,
            R.drawable.monitor_img1,
            R.drawable.monitor_info1_img2,
            R.drawable.monitor_info1_img4,
            R.drawable.monitor_info1_img3,
            R.drawable.monitor_info1_img5,
        )
