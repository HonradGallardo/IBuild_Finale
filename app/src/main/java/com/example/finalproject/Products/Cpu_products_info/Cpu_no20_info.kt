...
class Cpu_no20_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var cpuCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.cpu_no20_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.cpu_img20,
            R.drawable.cpu_info20_img1,
            R.drawable.cpu_info20_img2,
            R.drawable.cpu_info20_img3,
            R.drawable.cpu_info20_img4,)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(30, "AMD Ryzen 3 3300X", 6988.00, "CPU", R.drawable.cpu_img20, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)


            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Cpu20")
            startActivity(int)
        }
