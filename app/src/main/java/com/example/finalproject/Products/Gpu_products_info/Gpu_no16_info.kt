...
class Gpu_no16_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var cpuCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.gpu_no16_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.gpu_img16,
            R.drawable.gpu_info16_img1,
            R.drawable.gpu_info16_img2,
            R.drawable.gpu_info16_img3,
            R.drawable.gpu_info16_img4,
            R.drawable.gpu_info16_img5)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(46, "ASUS RX 6800", 33681.00, "GPU", R.drawable.gpu_img16, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)


            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Gpu16")
            startActivity(int)
        }
