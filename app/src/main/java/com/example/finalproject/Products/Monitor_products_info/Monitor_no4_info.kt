...
class Monitor_no4_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var MonitorCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.monitor_no4_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.monitor_info4_img1,
            R.drawable.monitor_img4,
            R.drawable.monitor_info4_img2,
            R.drawable.monitor_info4_img3,
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(82, "ASUS VZ239H-W 23 inch 60Hz", 7318.17, "Monitor", R.drawable.monitor_img4, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Monitor4")
            startActivity(int)
        }
