...
class Monitor_no10_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var MonitorCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.monitor_no10_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.monitor_info10_img1,
            R.drawable.monitor_img10,
            R.drawable.monitor_info10_img2,
            R.drawable.monitor_info10_img4,
            R.drawable.monitor_info10_img3,
        )
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(88, "Philips 246E9QDSB 24 inch 60Hz", 5673.00, "Monitor", R.drawable.monitor_img10, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Monitor10")
            startActivity(int)
        }
