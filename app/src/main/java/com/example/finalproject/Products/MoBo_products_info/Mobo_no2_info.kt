...
class Mobo_no2_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var MoboCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.mobo_no2_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.mobo_img2,
            R.drawable.mobo_info2_img1,
            R.drawable.mobo_info2_img3,
            R.drawable.mobo_info2_img2)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(60, "MSI B450M Mortar MAX", 5565.00, "MotherBoard", R.drawable.mobo_img2, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Mobo2")
            startActivity(int)
        }
