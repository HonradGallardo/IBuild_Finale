...
class Case_no9_info : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(9, "DarkFlash DK351 White ATX Gaming Case with 4 ARGB Fans", 2290.00, "CASE", R.drawable.darkflashdk351, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)


            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Case9")
            startActivity(int)
        }
