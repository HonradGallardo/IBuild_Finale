...
class Case_no3_info : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.case_no3_info)

        val Case_viewPager: ViewPager2 = findViewById(R.id.Case_viewPager2)

        val images = listOf(
            R.drawable.tecwareflatline,
            R.drawable.tecwareflatlineno2,
            )
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(3, "Tecware Flatline mATX High Airflow White", 2095.00, "CASE", R.drawable.tecwareflatline, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)


            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Case3")
            startActivity(int)
        }
