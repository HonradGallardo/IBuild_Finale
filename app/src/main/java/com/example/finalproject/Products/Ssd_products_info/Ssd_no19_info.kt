...
class Ssd_no19_info : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(157, "HP EX920 500GB", 5695.00, "Solid State Drive", R.drawable.ssd_img19, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Ssd19")
            startActivity(int)
        }
