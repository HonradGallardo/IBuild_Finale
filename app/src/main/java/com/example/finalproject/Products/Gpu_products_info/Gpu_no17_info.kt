...
class Gpu_no17_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var cpuCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.gpu_no17_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.gpu_img17,
            R.drawable.gpu_info17_img1,
            R.drawable.gpu_info17_img2,
            R.drawable.gpu_info17_img3,
            R.drawable.gpu_info17_img4,
            R.drawable.gpu_info17_img5)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(47, "GIGABYTE GTX 1660 OC", 11500.00, "GPU", R.drawable.gpu_img17, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)


            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Gpu17")
            startActivity(int)
        }
