...
class Mobo_no20_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var MoboCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.mobo_no20_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.mobo_img20,
            R.drawable.mobo_info20_img1,
            R.drawable.mobo_info20_img2,
            R.drawable.mobo_info20_img3)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(78, "MSI B450 GAMING PLUS", 7558.39, "MotherBoard", R.drawable.mobo_img20, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Mobo20")
            startActivity(int)
        }
