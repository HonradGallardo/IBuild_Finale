...
class Mobo_no17_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var MoboCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.mobo_no17_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.mobo_img17,
            R.drawable.mobo_info17_img1,
            R.drawable.mobo_info17_img2,
            R.drawable.mobo_info17_img3)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(75, "MSI MAG B550 TOMAHAWK", 10690.00, "MotherBoard", R.drawable.mobo_img17, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Mobo17")
            startActivity(int)
        }
