...
class Hdd_no4_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var cpuCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.hdd_no4_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.hdd_img4,
            R.drawable.hdd_info4_img1,
            R.drawable.hdd_info4_img2)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(54, "WD Red Pro WD4003FFBX HDD 4TB", 2450.00, "Hdd", R.drawable.hdd_img4, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)


            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Hdd4")
            startActivity(int)
        }
