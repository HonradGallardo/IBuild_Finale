...
class Psu_no5_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var PsuCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.psu_no5_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.psu_img5,
            R.drawable.psu_info5_img1,
            R.drawable.psu_info5_img2
        )
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(103, "Thermaltake Toughpower Grand RGB 750W", 5389.73, "Power Supply Unit", R.drawable.psu_img5, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Psu5")
            startActivity(int)
        }
