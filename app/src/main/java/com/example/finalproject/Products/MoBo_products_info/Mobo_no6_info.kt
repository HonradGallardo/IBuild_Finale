...
class Mobo_no6_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var MoboCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.mobo_no6_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.mobo_info6_img1,
            R.drawable.mobo_img6,
            R.drawable.mobo_info6_img2,
            R.drawable.mobo_info6_img3)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(64, "ASUS Prime B460M-A", 5875.00, "MotherBoard", R.drawable.mobo_img6, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Mobo6")
            startActivity(int)
        }
