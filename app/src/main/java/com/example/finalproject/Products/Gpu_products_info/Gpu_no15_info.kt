...
class Gpu_no15_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var cpuCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.gpu_no15_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.gpu_img15,
            R.drawable.gpu_info15_img1,
            R.drawable.gpu_info15_img2,
            R.drawable.gpu_info15_img3,
            R.drawable.gpu_info15_img4)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(45, "MSI GTX 1650 GAMING X", 12320.00, "GPU", R.drawable.gpu_img15, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)


            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Gpu15")
            startActivity(int)
        }
