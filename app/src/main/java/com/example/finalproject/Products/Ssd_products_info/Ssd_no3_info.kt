...
class Ssd_no3_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var SsdCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ssd_no3_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.ssd_info3_img1,
            R.drawable.ssd_img3,
            R.drawable.ssd_info3_img3,
            R.drawable.ssd_info3_img2
        )
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(141, "WD Blue 3D NAND 500GB", 3850.00, "Solid State Drive", R.drawable.ssd_img3, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Ssd3")
            startActivity(int)
        }
