...
class Ram_no5_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var RamCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ram_no5_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.ram_img5,
            R.drawable.ram_info5_img2,
            R.drawable.ram_info5_img1,
            R.drawable.ram_info5_img3
        )
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(123, "ADATA XPG Spectrix D80", 4950.00, "Ram", R.drawable.ram_img5, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Ram5")
            startActivity(int)
        }
