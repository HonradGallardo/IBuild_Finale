...
class Ssd_no10_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var SsdCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ssd_no10_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.ssd_img10,
            R.drawable.ssd_info10_img1,
            R.drawable.ssd_info10_img2,
        )
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(148, "Teamgroup GX2", 1475.00, "Solid State Drive", R.drawable.ssd_img10, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Ssd10")
            startActivity(int)
        }
