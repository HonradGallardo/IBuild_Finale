...
class Gpu_no4_info : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.gpu_no4_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.gpu_img4,
            R.drawable.gpu_info4_img1,
            R.drawable.gpu_info4_img2,
            R.drawable.gpu_info4_img3)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(34, "MSI RX 5700 XT MECH OC", 24461.00, "GPU", R.drawable.gpu_img4, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)


            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Gpu4")
            startActivity(int)
        }
