...
class Psu_no2_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var PsuCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.psu_no2_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.psu_info2_img1,
            R.drawable.psu_img2,
            R.drawable.psu_info2_img2,
            R.drawable.psu_info2_img4,
            R.drawable.psu_info2_img3,
        )
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(100, "Corsair RM750x", 7943.03, "Power Supply Unit", R.drawable.psu_img2, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Psu2")
            startActivity(int)
        }
