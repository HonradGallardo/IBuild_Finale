...
class Gpu_no5_info : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.gpu_no5_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.gpu_img5,
            R.drawable.gpu_info3_img1,
            R.drawable.gpu_info3_img2,
            R.drawable.gpu_info3_img3,
            R.drawable.gpu_info3_img4,
            R.drawable.gpu_info3_img5)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(35, "GIGABYTE RTX 3070 GAMING OC", 29500.00, "GPU", R.drawable.gpu_img5, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)


            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Gpu5")
            startActivity(int)
        }
