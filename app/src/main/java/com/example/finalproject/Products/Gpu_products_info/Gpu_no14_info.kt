...
class Gpu_no14_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var cpuCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.gpu_no14_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.gpu_img14,
            R.drawable.gpu_info14_img1,
            R.drawable.gpu_info14_img2,
            R.drawable.gpu_info14_img3,
            R.drawable.gpu_info14_img4)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(44, "GIGABYTE RX 590 GAMING Rev. 1.0", 15500.00, "GPU", R.drawable.gpu_img14, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)


            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Gpu14")
            startActivity(int)
        }
