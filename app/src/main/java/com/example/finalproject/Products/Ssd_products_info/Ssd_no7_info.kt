...
class Ssd_no7_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var SsdCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ssd_no7_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.ssd_info7_img1,
            R.drawable.ssd_info7_img2,
            R.drawable.ssd_img7,
            R.drawable.ssd_info7_img3
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(145, "PNY CS900 1TB", 1299.00, "Solid State Drive", R.drawable.ssd_img7, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Ssd7")
            startActivity(int)
        }
