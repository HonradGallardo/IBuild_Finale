...
class Ram_no16_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var RamCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ram_no16_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.ram_img16,
            R.drawable.ram_info16_img1,
            R.drawable.ram_info16_img2,
            R.drawable.ram_info16_img3
        )
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(134, "GeIL Evo X II", 3695.00, "Ram", R.drawable.ram_img16, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Ram16")
            startActivity(int)
        }
