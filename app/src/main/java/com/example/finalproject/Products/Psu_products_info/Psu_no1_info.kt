...
class Psu_no1_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var PsuCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.psu_no1_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.psu_img1,
            R.drawable.psu_info1_img1,
            R.drawable.psu_info1_img2,
            R.drawable.psu_info1_img3,
            R.drawable.psu_info1_img4
        )
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(99, "EVGA SuperNOVA 650 G5", 6240.83, "Power Supply Unit", R.drawable.psu_img1, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Psu1")
            startActivity(int)
        }
