...
class Ssd_no4_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var SsdCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ssd_no4_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.ssd_info4_img1,
            R.drawable.ssd_img4,
            R.drawable.ssd_info4_img3,
            R.drawable.ssd_info4_img2,
        )
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(142, "Sandisk Ultra 3D 1TB", 5450.00, "Solid State Drive", R.drawable.ssd_img4, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Ssd4")
            startActivity(int)
        }
