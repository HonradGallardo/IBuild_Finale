...
class Ssd_no13_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var SsdCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ssd_no13_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.ssd_info13_img1,
            R.drawable.ssd_img13,
            R.drawable.ssd_info13_img2
        )
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(151, "Crucial P1 500GB", 3981.11, "Solid State Drive", R.drawable.ssd_img13, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Ssd13")
            startActivity(int)
        }
