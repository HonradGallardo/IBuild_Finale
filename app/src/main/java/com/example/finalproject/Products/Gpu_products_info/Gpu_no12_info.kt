...
class Gpu_no12_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var cpuCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.gpu_no12_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.gpu_img12,
            R.drawable.gpu_info12_img1,
            R.drawable.gpu_info12_img2,
            R.drawable.gpu_info12_img3,
            R.drawable.gpu_info12_img4,
            R.drawable.gpu_info12_img5)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(42, "ASRock RX 5500 XT 8 GB BIOS", 10960.00, "GPU", R.drawable.gpu_img12, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)


            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Gpu12")
            startActivity(int)
        }
