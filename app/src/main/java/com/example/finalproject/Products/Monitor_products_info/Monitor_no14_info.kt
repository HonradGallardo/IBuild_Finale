...
class Monitor_no14_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var MonitorCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.monitor_no14_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.monitor_info14_img1,
            R.drawable.monitor_img14,
            R.drawable.monitor_info14_img2,
            R.drawable.monitor_info14_img3,
        )
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(92, "HP Pavilion 22cwa 22 inch 60Hz", 4537.83, "Monitor", R.drawable.monitor_img14, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Monitor14")
            startActivity(int)
        }
