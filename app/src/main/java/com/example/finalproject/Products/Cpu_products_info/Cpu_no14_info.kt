...
class Cpu_no14_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var cpuCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.cpu_no14_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.cpu_img14,
            R.drawable.cpu_info14_img1,
            R.drawable.cpu_info14_img2)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(24, "Intel Core i3-9100F", 8358.00, "CPU", R.drawable.cpu_img14, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)


            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Cpu14")
            startActivity(int)
        }
