...
class Monitor_no9_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var MonitorCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.monitor_no9_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.monitor_info9_img1,
            R.drawable.monitor_img9,
            R.drawable.monitor_info9_img2,
            R.drawable.monitor_info9_img4,
        )
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(87, "BenQ GW2480 24 inch 75Hz", 11345.43, "Monitor", R.drawable.monitor_img9, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Monitor9")
            startActivity(int)
        }
