...
class Mobo_no5_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var MoboCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.mobo_no5_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.mobo_img5,
            R.drawable.mobo_info5_img1,
            R.drawable.mobo_info5_img3,
            R.drawable.mobo_info5_img2)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(63, "Gigabyte B450 AORUS M", 4999.00, "MotherBoard", R.drawable.mobo_img5, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Mobo5")
            startActivity(int)
        }
