...
class Ssd_no17_info : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.ssd_no17_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.ssd_info17_img1,
            R.drawable.ssd_img17
        )
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(155, "Kingston A2000 500GB", 4695.00, "Solid State Drive", R.drawable.ssd_img17, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Ssd17")
            startActivity(int)
        }
