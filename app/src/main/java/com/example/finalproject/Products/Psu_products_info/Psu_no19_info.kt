...
class Psu_no19_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var PsuCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.psu_no19_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.psu_info19_img1,
            R.drawable.psu_img19,
            R.drawable.psu_info19_img2,
            R.drawable.psu_info19_img3
        )
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(117, "Cooler Master MasterWatt 650", 3120.13, "Power Supply Unit", R.drawable.psu_img19, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Psu19")
            startActivity(int)
        }
