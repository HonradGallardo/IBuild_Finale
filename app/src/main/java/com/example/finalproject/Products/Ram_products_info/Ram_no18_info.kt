...
class Ram_no18_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var RamCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ram_no18_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.ram_img18,
            R.drawable.ram_info18_img1,
        )
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(136, "Crucial Ballistix Tactical Tracer RGB", 4395.00, "Ram", R.drawable.ram_img18, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Ram18")
            startActivity(int)
        }
