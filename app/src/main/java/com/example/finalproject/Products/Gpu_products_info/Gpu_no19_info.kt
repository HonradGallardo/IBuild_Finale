...
class Gpu_no19_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var cpuCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.gpu_no19_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.gpu_img19,
            R.drawable.gpu_info19_img1,
            R.drawable.gpu_info19_img2,
            R.drawable.gpu_info19_img3,
            R.drawable.gpu_info19_img4)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(49, "GIGABYTE RTX 3060 Ti EAGLE OC", 28990.00, "GPU", R.drawable.gpu_img19, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)


            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Gpu19")
            startActivity(int)
        }
