...
class Monitor_no5_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var MonitorCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.monitor_no5_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.monitor_img5,
            R.drawable.monitor_info5_img1,
            R.drawable.monitor_info5_img3,
            R.drawable.monitor_info5_img2,)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(83, "Dell S2418H 23.8 inch 60Hz", 13615.20, "Monitor", R.drawable.monitor_img5, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Monitor5")
            startActivity(int)
        }
