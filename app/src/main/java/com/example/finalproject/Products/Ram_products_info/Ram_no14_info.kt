...
class Ram_no14_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var RamCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ram_no14_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.ram_img14,
            R.drawable.ram_info14_img1,
            R.drawable.ram_info14_img2
        )
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(132, "Patriot Viper 4 Blackout", 2740.86, "Ram", R.drawable.ram_img14, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Ram14")
            startActivity(int)
        }
