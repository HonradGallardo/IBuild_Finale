...
class Ssd_no1_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var SsdCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ssd_no1_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.ssd_info1_img1,
            R.drawable.ssd_img1,
            R.drawable.ssd_info1_img2
        )
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(139, "Samsung 860 EVO 500GB", 2540.00, "Solid State Drive", R.drawable.ssd_img1, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Ssd1")
            startActivity(int)
        }
