...
class Cpu_no12_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var cpuCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.cpu_no12_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.cpu_img12,
            R.drawable.cpu_info12_img1,
            R.drawable.cpu_info12_img2)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(21, "AMD Ryzen 3 3100", 7499.00, "CPU", R.drawable.cpu_img12, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)


            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Cpu12")
            startActivity(int)
        }
