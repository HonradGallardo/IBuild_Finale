...
class Mobo_no12_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var MoboCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.mobo_no12_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.mobo_info12_img1,
            R.drawable.mobo_img12,
            R.drawable.mobo_info12_img3,
            R.drawable.mobo_info12_img2,)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(70, "MSI MPG B550 Gaming Edge WiFi", 9950.00, "MotherBoard", R.drawable.mobo_img12, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Mobo12")
            startActivity(int)
        }
