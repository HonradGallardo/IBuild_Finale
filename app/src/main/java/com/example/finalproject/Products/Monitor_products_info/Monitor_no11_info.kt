...
class Monitor_no11_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var MonitorCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.monitor_no11_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.monitor_info11_img1,
            R.drawable.monitor_img11,
            R.drawable.monitor_info11_img2,
            R.drawable.monitor_info11_img3,
        )
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(89, "HP 22yh 22 inch 60Hz Monitor", 2855.00, "Monitor", R.drawable.monitor_img11, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Monitor11")
            startActivity(int)
        }
