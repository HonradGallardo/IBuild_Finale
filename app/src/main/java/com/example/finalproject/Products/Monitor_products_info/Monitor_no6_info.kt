...
class Monitor_no6_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var MonitorCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.monitor_no6_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.monitor_info6_img1,
            R.drawable.monitor_img6,
            R.drawable.monitor_info6_img2,
            R.drawable.monitor_info6_img4,
            R.drawable.monitor_info6_img3,)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(84, "Acer R240HY 23.8 inch 60Hz", 3970.53, "Monitor", R.drawable.monitor_img6, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Monitor6")
            startActivity(int)
        }
