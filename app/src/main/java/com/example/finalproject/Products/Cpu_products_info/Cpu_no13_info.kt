...
class Cpu_no13_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var cpuCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.cpu_no13_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.cpu_img13,
            R.drawable.cpu_info13_img1,
            R.drawable.cpu_info13_img2,
            R.drawable.cpu_info13_img3,
            R.drawable.cpu_info13_img4,)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(23, "AMD Ryzen 7 2700", 12169.00, "CPU", R.drawable.cpu_img13, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)


            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Cpu13")
            startActivity(int)
        }
