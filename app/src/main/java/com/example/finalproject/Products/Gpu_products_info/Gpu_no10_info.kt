...
class Gpu_no10_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var cpuCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.gpu_no10_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.gpu_img10,
            R.drawable.gpu_info10_img1,
            R.drawable.gpu_info10_img2,
            R.drawable.gpu_info10_img3,
            R.drawable.gpu_info10_img4,
            R.drawable.gpu_info10_img5,
            R.drawable.gpu_info10_img6,)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(40, "GIGABYTE RX 6700 XT GAMING OC GPU", 23234.00, "GPU", R.drawable.gpu_img10, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)


            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Gpu10")
            startActivity(int)
        }
