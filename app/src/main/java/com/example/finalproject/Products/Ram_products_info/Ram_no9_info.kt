...
class Ram_no9_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var RamCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ram_no9_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.ram_img9,
            R.drawable.ram_info9_img1,
            R.drawable.ram_info9_img2,
            R.drawable.ram_info9_img3
        )
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(127, "G.Skill Trident Z RGB", 2799.00, "Ram", R.drawable.ram_img9, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Ram9")
            startActivity(int)
        }
