...
class Gpu_no11_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var cpuCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.gpu_no11_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.gpu_img11,
            R.drawable.gpu_info11_img1,
            R.drawable.gpu_info11_img2,
            R.drawable.gpu_info11_img3,
            R.drawable.gpu_info11_img4)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(41, "ASUS TUF GTX 1660 Ti GAMING OC", 16999.00, "GPU", R.drawable.gpu_img11, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)


            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Gpu11")
            startActivity(int)
        }
