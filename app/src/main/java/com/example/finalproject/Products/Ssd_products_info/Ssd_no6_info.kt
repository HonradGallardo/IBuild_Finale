...
class Ssd_no6_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var SsdCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ssd_no6_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.ssd_info6_img2,
            R.drawable.ssd_img6,
            R.drawable.ssd_info6_img1,
            R.drawable.ssd_info6_img3,
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(144, "ADATA SU800 1TB", 3950.00, "Solid State Drive", R.drawable.ssd_img6, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Ssd6")
            startActivity(int)
        }
