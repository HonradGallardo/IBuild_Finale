...
class Mobo_no19_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var MoboCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.mobo_no19_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.mobo_info19_img1,
            R.drawable.mobo_info19_img2,
            R.drawable.mobo_info19_img3,
            R.drawable.mobo_img19,)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(77, "MSI B550-A PRO", 7295.00, "MotherBoard", R.drawable.mobo_img19, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Mobo19")
            startActivity(int)
        }
