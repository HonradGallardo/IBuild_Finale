...
class Monitor_no8_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var MonitorCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.monitor_no8_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.monitor_info8_img1,
            R.drawable.monitor_img8,
            R.drawable.monitor_info8_img2,
            R.drawable.monitor_info8_img4,
            R.drawable.monitor_info8_img3,
        )
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(86, "HP 24mh 24 inch 75Hz", 7091.25, "Monitor", R.drawable.monitor_img8, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Monitor8")
            startActivity(int)
        }
