...
class Ram_no1_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var RamCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ram_no1_info)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(119, "Corsair Vengeance LPX", 2660.00, "Ram", R.drawable.ram_img1, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Ram1")
            startActivity(int)
        }
