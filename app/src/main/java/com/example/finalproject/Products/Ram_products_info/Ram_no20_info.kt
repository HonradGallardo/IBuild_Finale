...
class Ram_no20_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var RamCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ram_no20_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.ram_img20,
            R.drawable.ram_info20_img1,
            R.drawable.ram_info20_img2,
        )
        ...
        addToCart.setOnClickListener {
            ...
            int.putExtra("previousActivity", "Ram20")
            startActivity(int)
        }
