...
class Hdd_no1_info : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.hdd_no1_info)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(51, "Seagate FireCuda HDD 2TB", 6190.00, "Hdd", R.drawable.hdd_img1, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)


            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Hdd1")
            startActivity(int)
        }
