...
class Mobo_no16_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var MoboCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.mobo_no16_info)

        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.mobo_info16_img1,
            R.drawable.mobo_img16,
            R.drawable.mobo_info16_img2,
            R.drawable.mobo_info16_img3)
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(74, "ASUS ROG Strix Z590-E Gaming WiFi 6E", 19490.00, "MotherBoard", R.drawable.mobo_img16, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Mobo16")
            startActivity(int)
        }
