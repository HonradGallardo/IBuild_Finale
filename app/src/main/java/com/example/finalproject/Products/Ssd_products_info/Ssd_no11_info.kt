...
class Ssd_no11_info : AppCompatActivity() {
    private lateinit var backbt : ImageView
    private lateinit var addToCart : Button
    private lateinit var SsdCart : ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ssd_no11_info)
        val viewPager2: ViewPager2 = findViewById(R.id.viewPager2)
        val images = listOf(
            R.drawable.ssd_info11_img1,
            R.drawable.ssd_img11,
            R.drawable.ssd_info11_img3
        )
        ...
        addToCart.setOnClickListener {
            ...
            val cartItem = Cart_Data_Class(149, "Samsung 970 EVO Plus 500GB", 4550.00, "Solid State Drive", R.drawable.ssd_img11, 1)
            val insertedRowId = databaseHelper.insertCartItem(cartItem)

            val int = Intent(this, Cart::class.java)
            int.putExtra("previousActivity", "Ssd11")
            startActivity(int)
        }
